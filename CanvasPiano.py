...
cs3 = canvas.create_polygon(35, 0, 35, 200, 65, 200, 65, 0, fill='black')
ds3 = canvas.create_polygon(85, 0, 85, 200, 115, 200, 115, 0, fill='black')
fs3 = canvas.create_polygon(185, 0, 185, 200, 215, 200, 215, 0, fill='black')
gs3 = canvas.create_polygon(235, 0, 235, 200, 265, 200, 265, 0, fill='black')
as4 = canvas.create_polygon(285, 0, 285, 200, 315, 200, 315, 0, fill='black')
cs4 = canvas.create_polygon(385, 0, 385, 200, 415, 200, 415, 0, fill='black')
ds4 = canvas.create_polygon(435, 0, 435, 200, 465, 200, 465, 0, fill='black')
fs4 = canvas.create_polygon(535, 0, 535, 200, 565, 200, 565, 0, fill='black')
gs4 = canvas.create_polygon(585, 0, 585, 200, 615, 200, 615, 0, fill='black')
as5 = canvas.create_polygon(635, 0, 635, 200, 665, 200, 665, 0, fill='black')
cs5 = canvas.create_polygon(735, 0, 735, 200, 765, 200, 765, 0, fill='black')
ds5 = canvas.create_polygon(785, 0, 785, 200, 815, 200, 815, 0, fill='black')
...
canvas.tag_bind(cs3, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/c-3.mp3'))
canvas.tag_bind(ds3, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/d-3.mp3'))
canvas.tag_bind(fs3, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/f-3.mp3'))
canvas.tag_bind(gs3, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/g-3.mp3'))
...
canvas.tag_bind(gs4, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/g-4.mp3'))
canvas.tag_bind(as5, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/a-5.mp3'))
canvas.tag_bind(cs5, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/c-5.mp3'))
canvas.tag_bind(ds5, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/d-5.mp3'))
canvas.tag_bind(fs5, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/f-5.mp3'))
canvas.tag_bind(gs5, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/g-5.mp3'))
canvas.tag_bind(as5, "<Button-1>", lambda event: buttonClick(event, path='resources/sounds/mp3Notes/a-5.mp3'))
